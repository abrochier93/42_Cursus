...
# define RL_VERSION_MINOR 2
   ...
   the code tells undo what to undo, not how to undo it. */
	...
	/* Bindable commands for killing and yanking text,
		and managing the kill ring. */
...
# endif
	...
	/* Things for vi mode. Not available unless readline is compiled
		-DVI_MODE. */
	...
	extern rl_command_func_t *rl_function_of_keyseq(const char *, Keymap,
			int *);
	...
	/* Functions for manipulating the funmap,
		which maps command names to functions. */
...
# endif
   ...
   current function. */
	...
	/* If non-zero,
		Readline gives values of LINES and COLUMNS from the environment
...
# define rl_symbolic_link_hook rl_directory_completion_hook
   ...
   application-specific completion function. */
	...
	/* If non-zero,
		readline will sort the completion matches.  On by default. */
