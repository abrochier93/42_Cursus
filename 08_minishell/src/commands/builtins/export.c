...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/03 19:55:34 by abrochie          #+#    #+#             */
/*   Updated: 2023/07/03 19:55:36 by abrochie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	single_export(t_mini *data)
{
	t_vlst	*temp;
...
{
	ft_putstr_fd("miishell: export: `", STDERR_FILENO);
	ft_putstr_fd(identifier, STDERR_FILENO);
	ft_putendl_fd("': not a valid identifier", STDERR_FILENO);
	return (EXIT_FAILURE);
}

static void	loop_and_export(char *var_name, t_mini *data)
{
	t_vlst	*temp;
